...
import { ChevronRight, Users, Shield, Check, ArrowRight } from "lucide-react";

const Hero = () => {
  return (
    <section
      id="home"
      className="relative min-h-screen flex items-center overflow-hidden pt-15"
    >
      {/* Background elements */}
      <AnimatedGradient
        ...
        <div className="md:col-span-2 space-y-8">
          <div className="flex flex-col items-start">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-6 bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">
              Maximizando o valor da saúde <br />
              <span className="text-health-400">com inteligência e segurança</span>
            </h1>

            <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-xl">
              Através de uma solução SaaS, baseada em tecnologias emergentes,
              oferecemos uma plataforma que otimiza os processos de auditoria
              hospitalar, trazendo segurança e eficiência
        ...
        <div className="relative md:col-span-3">
          ...
          >
            ...
            <div className="relative z-10 flex justify-center items-center p-4">
              <img
                src="/lovable-uploads/Logofull.png"
          ...
          <GlassmorphicCard className="p-4 md:p-6">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
              {[
                ...
                { icon: <Check className="h-5 w-5" />, text: "Eficiência operacional" },
                { icon: <Check className="h-5 w-5" />, text: "Otimização do fluxo de caixa" }
              ].map((item, i) => (
